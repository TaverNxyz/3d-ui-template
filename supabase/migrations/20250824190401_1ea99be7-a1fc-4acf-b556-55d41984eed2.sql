...
-- Insert sample global activity data (fixed column order)
INSERT INTO public.global_activity (activity_type, latitude, longitude, country_code, city, tool_used, severity) VALUES
('osint_scan', 40.7128, -74.0060, 'USA', 'New York', 'Criminal IP', 'high'),
('vulnerability_check', 51.5074, -0.1278, 'GBR', 'London', 'Shodan', 'medium'),
('social_analysis', 35.6762, 139.6503, 'JPN', 'Tokyo', 'Maltego', 'low'),
('email_harvest', 48.8566, 2.3522, 'FRA', 'Paris', 'TheHarvester', 'medium'),
('image_search', -33.8688, 151.2093, 'AUS', 'Sydney', 'TinEye', 'low'),
('analytics_track', 37.7749, -122.4194, 'USA', 'San Francisco', 'PostHog', 'low'),
('monitoring_alert', 52.5200, 13.4050, 'DEU', 'Berlin', 'Grafana', 'medium'),
('threat_detection', 55.7558, 37.6176, 'RUS', 'Moscow', 'Datadog', 'high'),
('metric_collection', 19.4326, -99.1332, 'MEX', 'Mexico City', 'Prometheus', 'low'),
('network_monitor', 1.3521, 103.8198, 'SGP', 'Singapore', 'Netdata', 'medium');
